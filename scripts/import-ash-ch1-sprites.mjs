/**
 * import-ash-ch1-sprites.mjs
 * 王城餘燼 5 隻怪物（灰燼殘兵/焦黑弓手/熔甲盾兵/焚旗軍官/灰燼守城官・雷沃克）
...
const SRC_DIR        = 'C:/Users/Anty/Desktop/圖檔/主線怪物/灰燼王城篇/王城餘燼_25張_中文檔名'
const DST_DIR        = 'public/assets/spritesheets/enemies'
const PAD_Y          = 22
const ALPHA_MIN      = 40
const MAX_HOLE       = 4000
const FRAME_MAP      = [0, 1, 2, 2, 3, 4]  // 5張→6格，複製第3張作為 attack_1
const TARGET_FRAME_W = 300

const TARGETS = [
  { id: 'ash_soldier',      name: '灰燼殘兵' },
  { id: 'charred_archer',   name: '焦黑弓手' },
  { id: 'molten_shieldman', name: '熔甲盾兵' },
  { id: 'ember_commander',  name: '焚旗軍官' },
  { id: 'levok',            name: '灰燼守城官・雷沃克' },
]
...
console.log('=== import-ash-ch1-sprites ===\n')
