/**
 * import-ash-ch2-sprites.mjs
 * 亡國迴廊 5 隻怪物（王城殘兵/灰燼侍衛/斷劍騎士/失魂宮廷法師/殘影禁衛長・羅恩）
...
const SRC_DIR        = 'C:/Users/Anty/Desktop/圖檔/主線怪物/灰燼王城篇/王國迴廊'
...
const TARGETS = [
  { id: 'castle_remnant',  name: '王城殘兵' },
  { id: 'ash_guard',       name: '灰燼侍衛' },
  { id: 'broken_knight',   name: '斷劍騎士' },
  { id: 'lost_court_mage', name: '失魂宮廷法師' },
  { id: 'laon',            name: '殘影禁衛長・羅恩' },
]
...
console.log('=== import-ash-ch2-sprites ===\n')
