/**
 * import-ash-covenant-sprites.mjs
 * 灰燼聖約副本 7 隻怪物 — 演算法完全同 import-throne-enemies.mjs
 * 來源：每隻 5 張個別 PNG（綠幕背景）
 * 用法: node scripts/import-ash-covenant-sprites.mjs
 */

import { PNG } from 'pngjs'
import { readFileSync, writeFileSync, readdirSync } from 'fs'

const SRC_DIR        = 'C:/Users/Anty/Desktop/圖檔/副本怪物/灰燼聖約/灰燼聖約_35張_中文檔名'
const DST_DIR        = 'public/assets/spritesheets/enemies'

const ENEMIES = [
  { prefix: '聖約殘焰',            out: 'covenant_ember'         },
  { prefix: '王血祭徒',            out: 'royal_blood_disciple'   },
  { prefix: '灰燼審判者',          out: 'ash_judge'              },
  { prefix: '萬民怨魂',            out: 'mass_resentment'        },
  { prefix: '聖約守衛',            out: 'covenant_guard'         },
  { prefix: '王冠祭司・塞羅恩',    out: 'crown_priest_seron'     },
  { prefix: '灰燼殘王・奧爾德雷克', out: 'ash_fallen_king_aldrek' },
]
...
// ── 綠幕判定（同 import-throne-enemies.mjs）────────────────────────────────
function isBg(r, g, b) {
