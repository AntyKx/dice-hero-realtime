/**
 * import-snow-enemies.mjs
 * 將雪原章節 5 張獨立 frame PNG 組合成 6-frame spritesheet
 * 支援兩種命名：「前綴N.png」和「前綴-N-描述.png」
 * 用法: node scripts/import-snow-enemies.mjs
 */
...
// ── 設定區 ────────────────────────────────────────────────────────────────────
const SRC_DIR = 'C:/Users/Anty/Desktop/圖檔/主線怪物/灰燼王城篇/雪原'
const DST_DIR = 'public/assets/spritesheets/enemies'

const ENEMIES = [
  { prefix: '冰霜狼',    out: 'ice_wolf'         },
  { prefix: '冰晶史萊姆', out: 'slimeking'        },
  { prefix: '冰甲騎士',  out: 'lightning_lancer'  },
  { prefix: '雪原巨怪',  out: 'yeti'              },
  { prefix: '冰霜女巫',  out: 'ice_witch'         },
]
