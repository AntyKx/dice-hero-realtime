/**
 * import-star-eclipse-enemies-v2.mjs
 * 星蝕裂隙副本 7 隻怪物置換版 — 演算法完全同 import-ash-covenant-sprites.mjs
 * 來源：每隻 5 張個別 PNG（綠幕背景）
 * 用法: node scripts/import-star-eclipse-enemies-v2.mjs
 */

import { PNG } from 'pngjs'
import { readFileSync, writeFileSync, readdirSync } from 'fs'

const SRC_DIR        = 'C:/Users/Anty/Desktop/圖檔/副本怪物/星蝕裂隙'
const DST_DIR        = 'public/assets/spritesheets/enemies'

const ENEMIES = [
  { prefix: '裂隙小鬼',   out: 'rift_imp'        },
  { prefix: '星沙魔偶',   out: 'star_sand_golem' },
  { prefix: '鏡像盜賊',   out: 'mirror_thief'    },
  { prefix: '星蝕修女',   out: 'eclipse_nun'     },
  { prefix: '裂隙守衛',   out: 'rift_guardian'   },
  { prefix: '星界收割者', out: 'star_reaper'     },
  { prefix: '暗月主教',   out: 'eclipse_bishop'  },
]
