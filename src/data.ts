...
export const HEROES: Hero[] = [
  ...
  // 實際輸出的 sprite sheet。
  { id: 'death_knight', name: '死亡騎士', title: '嗜血搏命', hp: 145, atk: 27, def: 10, role: 'death', school: 'physical', skill: '噬魂斬', desc: '血量越低傷害越高，攻擊疊血印進入血腥狀態獲得吸血與增傷。', sprite: H('death_knight', 280, 184), portrait: '/assets/portraits/death_knight.png', avatar: '/assets/avatars/death_knight.jpg',
    ...
    starSprites: [H('death_knight_s0', 297, 195), H('death_knight_s1', 297, 195), H('death_knight_s2', 297, 195), H('death_knight_s3', 297, 195)] },
