...
export const HEROES: Hero[] = [
  { id: 'knight', name: '聖騎士', title: '前排防禦', hp: 168, atk: 28, def: 14, role: 'slash', skill: '聖盾破軍斬', desc: '三條以上時傷害提升，五條時獲得護盾並嘲諷降低敵人本回合傷害30%。', sprite: H('knight', 173, 178), portrait: '/assets/portraits/knight.png',
    starSprites: [
      H('knight_s0', 423, 320),
      H('knight_s1', 356, 320),
      H('knight_s2', 393, 320),
  ...
  { id: 'mage', name: '火焰法師', title: '爆發法術', hp: 102, atk: 39, def: 5, role: 'fire', skill: '烈焰隕星', desc: '順子以上時追加爆發傷害並施加 2 層燃燒。', sprite: H('mage', 173, 184), portrait: '/assets/portraits/mage.png',
    starSprites: [
      H('mage_s0', 374, 320),
      H('mage_s1', 345, 320),
      H('mage_s2', 315, 320),
  ...
  { id: 'priest', name: '神官祭司', title: '治療輔助', hp: 122, atk: 18, def: 8, role: 'holy', skill: '光輪祝禱', desc: '骰到 6 越多，回復量越高。', sprite: H('priest', 173, 184), portrait: '/assets/portraits/priest.png',
    starSprites: [
      H('priest_s0', 243, 320),
      H('priest_s1', 259, 320),
      H('priest_s2', 274, 320),
  ...
  { id: 'rogue', name: '影刃刺客', title: '高速爆擊', hp: 108, atk: 31, def: 5, role: 'shadow', skill: '暗影連襲', desc: '兩對以上觸發連擊加傷，有機率爆擊造成大量額外傷害。', sprite: H('rogue', 175, 167), portrait: '/assets/portraits/rogue.png',
    starSprites: [
      H('rogue_s0', 415, 320),
      H('rogue_s1', 425, 320),
      H('rogue_s2', 484, 320),
  ...
  { id: 'princess', name: '皇家公主', title: '冰痕控制', hp: 118, atk: 24, def: 8, role: 'ice', skill: '皇家冰晶陣', desc: '技能施加護盾；兩對以上疊冰痕；順子以上凍結；對凍結敵人追加冰晶傷害。冰痕每層 +4% 傷害，5 層觸發碎冰爆發。', sprite: H('princess', 173, 174), portrait: '/assets/portraits/princess.png',
    starSprites: [
  ...
  { id: 'archer', name: '遊俠獵人', title: '遠程輸出', hp: 114, atk: 26, def: 7, role: 'arrow', skill: '疾風箭雨', desc: '順子以上時追加箭雨傷害。', sprite: H('archer', 177, 166), portrait: '/assets/portraits/archer.png',
    starSprites: [
      H('archer_s0', 361, 320),
      H('archer_s1', 483, 320),
      H('archer_s2', 349, 320),
  ...
  { id: 'dwarf', name: '矮人戰士', title: '重擊破甲', hp: 148, atk: 27, def: 12, role: 'hammer', skill: '震地戰錘', desc: '三條以上時破甲 -3，削減敵人防禦。', sprite: H('dwarf', 180, 183), portrait: '/assets/portraits/dwarf.png',
    starSprites: [H('dwarf_s0', 384, 320), H('dwarf_s1', 328, 320), H('dwarf_s2', 340, 320), H('dwarf_s3', 354, 320)] },
  { id: 'bard', name: '吟遊詩人', title: '團隊增益', hp: 108, atk: 19, def: 6, role: 'song', skill: '戰歌奏鳴', desc: '可在造成傷害同時小幅回血。', sprite: H('bard', 169, 180), portrait: '/assets/portraits/bard.png',
    starSprites: [H('bard_s0', 355, 320), H('bard_s1', 342, 320), H('bard_s2', 315, 320), H('bard_s3', 317, 320)] },
  { id: 'beastmaster', name: '獸語馴獸師', title: '協同進攻', hp: 132, atk: 24, def: 9, role: 'beast', skill: '狼魂突擊', desc: '技能傷害穩定，並有少量反擊保護。', sprite: H('beastmaster', 180, 161), portrait: '/assets/portraits/beastmaster.png',
    starSprites: [H('beastmaster_s0', 339, 320), H('beastmaster_s1', 300, 320), H('beastmaster_s2', 347, 320), H('beastmaster_s3', 332, 320)] },
  { id: 'engineer', name: '機關技師', title: '機械火力', hp: 120, atk: 23, def: 8, role: 'gear', skill: '蒸氣砲擊', desc: '兩對以上時機關炮追加固定傷害。', sprite: H('engineer', 175, 175), portrait: '/assets/portraits/engineer.png',
    starSprites: [H('engineer_s0', 295, 320), H('engineer_s1', 313, 320), H('engineer_s2', 339, 320), H('engineer_s3', 324, 320)] },
  { id: 'fighter', name: '武鬥家', title: '連招拳勢', hp: 125, atk: 28, def: 9, role: 'fighter', skill: '真氣運轉', desc: '連續技觸發時獲得拳勢（最多5層）；每層傷害+3%受傷-2%；拳勢滿進入無雙架式2回合。技能效果依最近連段類型強化。', sprite: H('fighter_s0', 262, 188), portrait: '/assets/portraits/fighter.png',
