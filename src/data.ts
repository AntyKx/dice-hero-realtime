...
export const HEROES: Hero[] = [
  ...
  { id: 'mage', name: '火焰法師', title: '爆發法術', hp: 102, atk: 39, def: 5, role: 'fire', school: 'magic', skill: '烈焰隕星', desc: '順子以上時追加爆發傷害並施加 2 層燃燒。', sprite: H('mage', 237, 184), portrait: '/assets/portraits/mage.png', avatar: '/assets/avatars/mage.jpg',
  ...
  // 實際輸出的 sprite sheet。
  { id: 'death_knight', name: '死亡騎士', title: '嗜血搏命', hp: 145, atk: 27, def: 10, role: 'death', school: 'physical', skill: '噬魂斬', desc: '血量越低傷害越高，攻擊疊血印進入血腥狀態獲得吸血與增傷。', sprite: H('death_knight', 239, 184), portrait: '/assets/portraits/death_knight.png', avatar: '/assets/avatars/death_knight.jpg',
    ...
    starSprites: [H('death_knight_s0', 307, 236), H('death_knight_s1', 307, 236), H('death_knight_s2', 307, 236), H('death_knight_s3', 307, 236)] },
  { id: 'engineer', name: '機關技師', title: '機械火力', hp: 120, atk: 23, def: 8, role: 'gear', school: 'physical', skill: '蒸氣砲擊', desc: '兩對以上時機關炮追加固定傷害。', sprite: H('engineer', 285, 184), portrait: '/assets/portraits/engineer.png', avatar: '/assets/avatars/engineer.jpg',
    ...
    starSprites: [H('engineer_s0', 351, 227), H('engineer_s1', 351, 227), H('engineer_s2', 351, 227), H('engineer_s3', 351, 227)] },
